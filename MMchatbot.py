...
# CBT-Based Response Mapping
cbt_responses = {
    "Neutral": "It's great to have a balanced state of mind. Would you like to talk about something that interests you?",
    "Happy": "I'm glad to hear that! What made you feel happy today? 😊",
    "Sad": "I'm sorry you're feeling this way. Would you like to try reframing your thoughts or talk about something comforting?",
    "Angry": "It sounds like something has upset you. Let's take a deep breath together. What happened?",
    "Surprised": "That sounds unexpected! How do you feel about it?",
    "Disgust": "It seems like something didn’t sit well with you. Would talking about it help?",
    "Fear": "I understand that can be scary. What’s something small that could help you feel safer right now?"
}
...
def chatbot_interaction():
    ...
    while True:
        ...
        print(f"🤖 Chatbot: Detected Emotion → {detected_emotion}")
        print(f"💡 CBT Response: {cbt_responses[detected_emotion]}")
